...
use crate::types::{log_markers::LogMarker, Connections, NamedPeer, NamelessPeer, SendToOneError};
...
impl Comm {
    ...
    #[allow(unused)]
    pub(crate) async fn disconnect(&self, peer: &NamedPeer) {
        self.connections.disconnect(peer.id()).await;
    }
