...
mod test {
    ...
    fn generating_network_id() {
        ...
        assert_eq!(user1_id1,
                   unwrap_result!(Account::generate_network_id(keyword1.as_bytes(), 0.to_string().as_bytes())));
        assert_eq!(user1_id2,
                   unwrap_result!(Account::generate_network_id(keyword1.as_bytes(), 1234.to_string().as_bytes())));
        assert_eq!(user1_id3,
