...
fn mutable_data_permissions() {
    ...
    let value1_v1 = unwrap!(utility::generate_random_vector(10));
    ...
    let key3 = b"key3";
    let value3_v0 = unwrap!(utility::generate_random_vector(10));
    ...
    let key4 = b"key4";
    let value4_v0 = unwrap!(utility::generate_random_vector(10));
