...
impl Action for GetFile {
    fn execute(&mut self, params: ParameterPacket) -> ResponseType {
        trace!("JSON get file located at given path starting from home directory of \"//{}.{}\".",
               self.service_name,
               self.long_name);
...
mod test {
    ...
    fn get_public_file_using_registerd_client() {
        ...
        let unreg_parameter_packet = unwrap!(test_utils::get_unregistered_parameter_packet());
