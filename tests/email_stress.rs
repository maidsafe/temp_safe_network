...
impl Bot {
    fn new(n: usize) -> Self {
        ...
        let sec_0 = unwrap!(utility::generate_random_vector::<u8>(10));
        let sec_1 = unwrap!(utility::generate_random_vector::<u8>(10));
