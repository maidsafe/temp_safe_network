...
safe_completion_url="https:\/\/github.com\/maidsafe\/safe-api\/releases\/download\/$api_version\/safe_completion.sh"
s3_linux_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-api-$api_version-x86_64-unknown-linux-gnu-dev.zip"
s3_win_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-api-$api_version-x86_64-pc-windows-gnu-dev.zip"
s3_macos_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-api-$api_version-x86_64-apple-darwin-dev.zip"
...
s3_ffi_dev_linux_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-ffi-$ffi_version-x86_64-unknown-linux-gnu-dev.zip"
s3_ffi_dev_win_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-ffi-$ffi_version-x86_64-pc-windows-gnu-dev.zip"
s3_ffi_dev_macos_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-ffi-$ffi_version-x86_64-apple-darwin-dev.zip"
s3_ffi_dev_android_x86_64_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-ffi-$ffi_version-x86_64-linux-android-dev.zip"
s3_ffi_dev_android_armv7_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-ffi-$ffi_version-armv7-linux-androideabi-dev.zip"
s3_ffi_dev_ios_deploy_url="https:\/\/safe-api.s3.amazonaws.com\/safe-ffi-$ffi_version-apple-ios-dev.zip"
