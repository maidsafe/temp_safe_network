...
use safe_nd::{
    ...
    ADataPubPermissions, ADataUser, AppendOnlyData, Error as SndError, PubUnseqAppendOnlyData,
    PublicKey, UnseqAppendOnly, XorName,
};
...
fn ad_created_by_app() {
    ...
    unwrap!(run(&app, |client, _| {
        ...
        let tag = 15_002;
        let mut invalid_data = PubUnseqAppendOnlyData::new(name, tag);
