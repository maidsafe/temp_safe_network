...
/// the log output file.
#[no_mangle]
pub unsafe extern "C" fn app_init_logging(output_file_name_override: *const c_char,
...
#[no_mangle]
pub unsafe extern "C" fn app_output_log_path(output_file_name: *const c_char,
                                             user_data: *mut c_void,
    ...
    catch_unwind_cb(user_data, o_cb, || -> Result<(), AppError> {
        ...
        let op_file_path =
            CString::new(fh.path()
                             ...
                             .into_string()
                             .map_err(|_| {
                                          AppError::Unexpected("Couldn't convert OsString"
                                                                   .to_string())
                                      })?
                             .into_bytes())?;
...
mod tests {
    ...
    fn file_logging() {
        ...
        unsafe {
            unwrap!(call_0(|ud, cb| app_init_logging(log_file_path.as_ptr(), ud, cb)));
        }
