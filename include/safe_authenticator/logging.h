...
/// the log output file.
void auth_init_logging(char const* output_file_name_override, void* user_data, void (*o_cb)(void* , FfiResult ));
...
void auth_output_log_path(char const* output_file_name, void* user_data, void (*o_cb)(void* , FfiResult , char const* ));
