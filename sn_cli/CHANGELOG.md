...
Please use the `--help` arguments on the commands for further details as to their usage. The README for the CLI will be updated shortly to contain more details, but in the mean time, we've put some more elaborate descriptions directly into each of the commands on the CLI.
